...
using IdentityServer7.EntityFramework.Entities;
using IdentityServer7.EntityFramework.Extensions;
using IdentityServer7.EntityFramework.Interfaces;
using IdentityServer7.EntityFramework.Options;
using Microsoft.EntityFrameworkCore;

namespace IdentityServer7.EntityFramework.DbContexts
{
    /// <summary>
    /// DbContext for the IdentityServer operational data.
    /// </summary>
    /// <seealso cref="Microsoft.EntityFrameworkCore.DbContext" />
    /// <seealso cref="IdentityServer7.EntityFramework.Interfaces.IPersistedGrantDbContext" />
